...
public class Game {
	...
	private static void initPlayerGrid(Player p) {
		...
		System.out.println("Votre grille est complËte.");
		p.displayGrid();
	...
	private static void initGame() {
		...
		System.out.println("Appuyez sur entrÈe pour changer de joueur.");
		scan.nextLine();
		hideGame();
		...
		System.out.println("Appuyez sur entrÈe pour commencer la partie.");
		scan.nextLine();
		hideGame();
	}
	public static boolean shot() {
		System.out.println(currentPlayer.getName() + ", entrez une coordonnÈe √† attaquer.\n");
